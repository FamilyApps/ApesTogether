...
## 3. The Paper Trading Premium/Discount Question

### Arguments for LOWER pricing (vs. $9):
- **No real execution:** Users must manually copy trades in their own brokerage. This is extra friction and effort.
...
### Arguments for KEEPING or RAISING pricing (vs. $9):
- **Unique value:** Real-time trade alerts from verified performers. Nobody else offers this specific signal.
- **Lower total cost than competitors:** Dub costs $10+/month PLUS per-creator fees PLUS $3/month maintenance. eToro hides costs in spreads. Your $9/month all-in is transparent and cheaper.
...
- **Substack comp:** Financial newsletters charge $5-15/month for text analysis. You provide real-time actionable signals with verified performance history.
...
## 4. Portfolio Size & Fee Drag Analysis

| Portfolio Size | Apes Together ($9/mo, 1 trader) | Dub (~$13/mo total) | Autopilot ($8.33/mo) |
|---|---|---|---|
| $1,000 | 10.8% annual drag | 15.6% annual drag | 10.0% annual drag |
| $2,500 | 4.3% | 6.2% | 4.0% |
| $5,000 | 2.2% | 3.1% | 2.0% |
| $10,000 | 1.1% | 1.6% | 1.0% |
| $25,000 | 0.4% | 0.6% | 0.4% |

**Key insight:** At any portfolio size, your fee drag is comparable to Autopilot and BETTER than Dub. But for accounts under $2,500, the percentage drag is high for any subscription service. This is an industry-wide issue, not specific to you.

---

## 5. Creator Compensation Analysis

### Why 85% rev share is correct:

**Your model:** Creator earns $6.50/subscriber/month (85% of $9 × 0.85 after Apple's 15% Small Business Program fee = $7.65 → creator gets 85% = $6.50).

Wait — let me recalculate based on your actual structure:
- Subscriber pays: $9/month via App Store IAP
- Apple takes: 15% (Small Business Program) = $1.35
- Net to you: $7.65
- Creator gets 85% of net: $6.50
- You retain: $1.15 (15% of net)

**Comparison:**
| Platform | Creator earning per subscriber equivalent |
|---|---|
| **Apes Together** | **$6.50/sub/month** (transparent, guaranteed) |
...
**Your 85% share is the highest transparent rev-share in copy/social trading.** This is a legitimate competitive advantage for recruiting traders. Keep it.
...
- A trader with 50 subscribers earns $325/month for reporting maybe 5-15 trades
- That's $20-65 per trade reported — excellent $/effort ratio
...
## 7. Annual Plan Recommendation

**Add: $79/year option (27% savings vs monthly)**

Rationale:
- Dub charges $89.99/year (25% savings)
- Your annual at $79 undercuts Dub's annual while your monthly ($9) is already below their monthly ($10+)
- Annual plans reduce churn significantly (users forget to cancel, feel committed)
- $79/year ÷ 12 = $6.58/month perceived cost — well below impulse threshold
- Creator payout on annual: $6.50 × 12 = $78/year per subscriber, so you'd pay out ~$56.18 (85% of net $66.10 after Apple's 15% cut) — still viable
...
|---------|---------|-------------|-----------|
| Monthly price | $9/month | **$9/month (keep)** | Competitive, below Dub, above impulse threshold |
| Annual price | None | **$79/year (add)** | 27% discount, undercuts Dub, reduces churn |
...
Your target subscriber with a $4,000 portfolio paying $9/month faces a 2.7% annual fee drag. That's:
- **Comparable** to a typical actively managed ETF (0.5-1.5% expense ratio + opportunity cost of NOT beating the market)
- **Better than** Dub's total cost (~$156/year for one creator = 3.9% on $4K)
- **Worse than** eToro's "free" (but eToro requires $200 min, locks your money in their platform, and hides fees in spreads)

The value proposition justification: If a trader you follow beats the S&P 500 by even 3-5%, your $108/year subscription pays for itself many times over on a $4K portfolio. The paper trading layer means subscribers can validate this BEFORE risking real money — a unique advantage nobody else offers.

---

## 9. Competitive Vulnerabilities to Monitor
...
Your $9/month is NOT too high. It's actually aggressive pricing given what competitors charge. The main risk isn't price — it's **perceived value for paper-only trading**. Your messaging must constantly reinforce:
...
That positions the subscription as a **research and discovery tool** (worth $9/month easily) rather than a "trading service" (where users expect execution for their money).
