...
**Tier 1 (Day 12+):** Large creators. Unlikely to respond to cold outreach but worth trying. Low conversion expectation.
**Tier 2 (Day 8+):** Mid-size, niche creators. Best ROI — large enough to matter, small enough to engage.
**Tier 3 (Day 4+):** Micro-creators and active community members. Highest conversion rate. Start here.

## General Approach
1. **First contact:** Short, personalized DM or email. Under 100 words.
2. **Follow-up (1 week later if no reply):** Even shorter. One sentence + link.
3. **Never send a third message.** If they don't reply twice, move on.
4. **Always offer something:** Beta access, exclusive feature, data for content.
5. **Never ask them to "promote" you.** Ask them to try it and share their honest opinion.

---

## TIER 3 — MICRO-CREATORS (Start Day 4)
*Send via DM on their primary platform. Keep under 80 words.*
...
## TIER 2 — MID-SIZE NICHE CREATORS (Start Day 8)
*Send via email if available, DM if not. Under 100 words.*
...
## TIER 1 — LARGE CREATORS (Start Day 12)
*Send via email only. Professional tone. Under 120 words.*
...
## INFLUENCER FOLLOW-UP (Send 7 days after first message if no reply)

### Universal Follow-Up Template
```
...
[Your name]
```
*Never send a third message. If no reply after follow-up, move on.*
...
**Tier 1:** WSJ, Bloomberg, TechCrunch, Business Insider, CNBC, The Verge
**Tier 2:** Finextra, Product Hunt, Fast Company, Wired, Axios
**Tier 3:** Niche fintech blogs, startup press, creator economy publications

## Story Angles (Use These as Subject Lines / Hooks)

1. **"The Anti-Finfluencer App"** — Platform requires verified trades, making performance transparent
2. **"Apes Grow Up"** — From meme stock chaos to verified performance marketplace
3. **"The Creator Economy Meets Wall Street"** — Traders earn subscriber revenue from performance, not content
4. **"Solo Founder, Zero VC"** — NYC developer builds fintech marketplace alone
5. **"Algorithms vs. Humans"** — Platform explicitly welcomes AI/bot traders competing with humans

## Press Kit Contents (Prepare by Day 16)
- 1-page company overview PDF
- 3 high-res app screenshots (leaderboard, trader profile, notification)
- Founder headshot
- Founder bio (3 sentences)
- Boilerplate (company description paragraph)
- Key stats (after beta): DAU, trades/day, retention, trader count
- Link to beta (TestFlight / Play Console)

---

## TIER 3 — NICHE FINTECH PRESS (Start Day 16)
...
## TIER 2 — TECH/STARTUP PRESS (Start Day 18)

### Template: Tech Publications (Fast Company, Axios, Wired)
```
Subject: [Angle — pick from the 5 story angles above]
...
## TIER 1 — MAJOR PRESS (Start Day 24)
...
## JOURNALIST FOLLOW-UP (Send 5-7 days after initial pitch)
...
# REPORTER TARGET LIST (Cascade's Recommendations)

*Note: User has a separate reporter list to synthesize. These are my recommendations.*

## Tier 1

| Name | Outlet | Beat | Why They'd Care |
|------|--------|------|-----------------|
| Alexander Osipovich | WSJ | Market structure, exchanges | Social trading as new market structure |
| Julia Boorstin | CNBC | Creator economy, media tech | Creator economy meets finance angle |
| Sarah Perez | TechCrunch | Mobile apps, consumer tech | New app launch, solo founder |
| Marguerite Ward | Business Insider | Startups, future of work | Solo founder bootstrapping story |
| Casey Newton | Platformer | Platform economy | Platform dynamics in finance |

## Tier 2

| Name | Outlet | Beat | Why They'd Care |
|------|--------|------|-----------------|
| Ryan Lawler | Finextra | Fintech | Core fintech beat |
| Nathaniel Popper | Freelance (ex-NYT) | Fintech, crypto | Retail investing evolution |
| Erin Griffith | NYT/DealBook | Startups | Bootstrapped vs VC-funded angle |
| David Ingram | NBC News | Tech/apps | Consumer tech angle |
| Taylor Lorenz | Freelance | Creator economy | Creator economy expansion into finance |

## Tier 3

| Name | Outlet | Beat | Why They'd Care |
|------|--------|------|-----------------|
| Product Hunt community | Product Hunt | New products | Launch day post |
| Hacker News community | YC News | Technical products | Technical solo founder story |
| Ryan Hoover | Product Hunt founder | Products | Could feature in newsletter |
| Various | IndieHackers | Solo founders | Bootstrapped fintech story |
| Various | r/startups mods | Startups | Community engagement |
...
| Name | Platform | Tier | First Contact Date | Method (DM/Email) | Response? | Follow-Up Date | Beta Sent? | Content Published? | Notes |
|------|----------|------|-------------------|-------------------|-----------|----------------|------------|-------------------|-------|
